...
export const metadata: Metadata = {
  title: "Register",
  description: "Register route placeholder for the Next.js App Router structure.",
};
    ...
    <AppLayout>
      <div className="mx-auto max-w-md glass rounded-3xl p-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          This route is ready for an auth integration. Current GPA data remains browser-local.
        </p>
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Already registered? <Link href="/login" className="text-primary underline-offset-4 hover:underline">Login</Link>
        </p>
      </div>
    </AppLayout>
  );
